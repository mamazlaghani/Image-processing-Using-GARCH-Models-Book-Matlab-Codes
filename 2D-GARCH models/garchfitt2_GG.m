...
size(lowerBounds);
[coefficients , LLF, exitFlag , output , lambda] =  fmincon('garchlfn22_GG'  , x0 , A  , b, Aeq , beq ,lowerBounds ,upperBounds ,[], [] ,y , r1 , r2 , m1 , m2, p1 , p2, q1 , q2, van, X);
[LLF , G , H , e , hh] = garchlfn22_GG(coefficients , y , r1 , r2 , m1 , m2 , p1 ,p2 ,q1 , q2 ,van, X);
