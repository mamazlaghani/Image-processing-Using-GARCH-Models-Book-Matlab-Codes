function [LLF , G , H , e , hfinal] = garchlfnGM(Parameters , y , pp , R , M , P , Q , X);
...
%
%
% the difference between this program and GARCHfittGM is in the constraint
%  of optimization. the nonlinear file here is confun221extra that have an
%  extra constraint that summation of every GARCH parameters related to
%  every gaussian density of GM must be less than 1
