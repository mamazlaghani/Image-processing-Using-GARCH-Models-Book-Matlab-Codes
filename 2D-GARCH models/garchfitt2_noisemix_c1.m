function [coefficients,h,h1,h2,e] = garchfitt2_noisemix_c1(spec,y,me1,me2,va1,va2,prob,X);
...
size(lowerBounds);
[coefficients , LLF, exitFlag , output , lambda] =  fmincon('garchlfn22_noisemix_c1'  , x0 , A  , b, Aeq , beq ,lowerBounds ,upperBounds ,[], [] ,y , r1 , r2 , m1 , m2, p1 , p2, q1 , q2, me1, me2, va1, va2, prob, X);
[LLF , G , H , e , h, h1 , h2] = garchlfn22_noisemix_c1(coefficients , y , r1 , r2 , m1 , m2 , p1 ,p2 ,q1 , q2 , me1, me2, va1, va2, prob, X);
