function [LLF , G , H , e , hh] = garchlfn22_causin(Parameters , y , r1 , r2 , m1 , m2 , p1 ,p2 ,q1 , q2 , X, cc1, cc2 );
causin=Parameters(1:2);
...
h    =  garchlfgarch2_causin(p1 , p2 ,q1, q2 , nPaths, varianceCoefficients , e2 , T1 , T2, causin, cc1, cc2);
LLF=0;
for i=maxpq1+1:T1
    for j=maxpq2+1:T2
