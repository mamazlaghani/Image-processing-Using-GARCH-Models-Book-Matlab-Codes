...
size(lowerBounds);
[coefficients , LLF, exitFlag , output , lambda] =  fmincon('garchlfn22_mixture'  , x0 , A  , b, Aeq , beq ,lowerBounds ,upperBounds ,'garchnlc2_mixture', [] ,y , r1 , r2 , m1 , m2, p1 , p2, q1 , q2, X);
LLF
[LLF , G , H , e , hh, hh1, hh2] = garchlfn22_mixture(coefficients , y , r1 , r2 , m1 , m2 , p1 ,p2 ,q1 , q2 , X);
