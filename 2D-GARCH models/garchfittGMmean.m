function [coefficients,hh,e,H5] = garchfittGMmean(spec,y,pp,X);
R=spec(1);
M=spec(2);
P=spec(3);
Q=spec(4);
...
coefficients  =  fmincon('garchlfnGMmean'  , x0 , A  , b, Aeq , beq ,lowerBounds ,upperBounds ,@confun221mean,[] ,y , pp , R , M , P , Q , X);
...
[LLF , G , H5 , e , hh] = garchlfnGMmean(coefficients , y , pp , R , M , P, Q , X);
