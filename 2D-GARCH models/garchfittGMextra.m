function [coefficients,hh,e] = garchfittGMextra(spec,y,pp,X);
%
%
%
%
...
coefficients  =  fmincon('garchlfnGM'  , x0 , A  , b, Aeq , beq ,lowerBounds ,upperBounds ,@confun221extra,[] ,y , pp , R , M , P , Q , X);
