function [coefficients,hh,e] = garchfitt(spec,y,X,specc);
R=spec(1);
M=spec(2);
P=spec(3);
Q=spec(4);
...
%[asd,fgh]=size(x0);
%x0=zeros(asd,fgh);
[coefficients , LLF, exitFlag , output , lambda] =  fmincon('garchlfn'  , x0 , A  , b, Aeq , beq ,lowerBounds ,upperBounds ,[],[] ,y , R , M , P , Q , X);
