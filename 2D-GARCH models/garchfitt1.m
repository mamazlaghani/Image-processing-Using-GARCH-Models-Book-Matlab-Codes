function [coefficients,hh,e] = garchfitt1(spec,y,X,specc);
R=spec(1);
M=spec(2);
P=spec(3);
Q=spec(4);
...
[coefficients , LLF, exitFlag , output , lambda] =  fmincon('garchlfn'  , x0 , A  , b, Aeq , beq ,lowerBounds ,upperBounds ,@confun2,[] ,y , R , M , P , Q , X);
%[coefficients , LLF, exitFlag , output , lambda] =  fmincon('garchlfn22'  , x0 , A  , b, Aeq , beq ,lowerBounds ,upperBounds ,[],[] ,y , R ,0, M ,0, P,0 , Q ,0, X);
[LLF , G , H , e , hh] = garchlfn(coefficients , y ,R , M , P, Q , X);
